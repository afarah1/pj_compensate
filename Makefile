...
pj_compensate:
	...
	$(CC) src/pj_compensate.c events.o reader.o queue.o compensation.o \
		-o pj_compensate $(FLAGS)
	rm -f events.o reader.o queue.o compensation.o

clean:
	rm -f events.o reader.o queue.o compensation.o pj_compensate
